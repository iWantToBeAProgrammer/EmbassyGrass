        ...
        <div className={styles.card}>
          <div className="card-body lg:w-72 md:w-60 w-[7.5rem] p-2 md:p-4">
            <figure className="relative">
              ...
              />
              <div className="badge absolute bottom-1 left-1 border border-solid border-black rounded-bl-none font-dmserif font-normal md:text-[0.875rem] text-[0.4rem]">{title}</div>
            </figure>

            <p className="font-['dmserif'] text-[0.5rem] md:text-base text-[#4D5053]">{desc}</p>
        ...
        <div className={styles.card}>
          <div className="card-body lg:w-[28.5rem] md:w-[23rem]">
            <figure className="relative">
              ...
              />
              <div className="badge absolute bottom-1 left-1 border border-solid border-black rounded-bl-none font-dmserif font-normal">{title}</div>
            </figure>
